 ...
 *
 * Run with:
 *   ./gradlew :compose-highlight:connectedAndroidTest -P android.testInstrumentationRunnerArguments.class=dev.hossain.highlight.benchmark.HighlightEngineBenchmark
 */
