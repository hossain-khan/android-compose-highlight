...
tasks.register<JacocoReport>("jacocoTestReport") {
    ...
    classDirectories.setFrom(files(
        fileTree(buildDir.dir("intermediates/runtime_library_classes_dir/debug")) {
            exclude("**/R.class", "**/R\$*.class", "**/BuildConfig.*")
        }
    ))
    // Use the actual coverage file location generated by enableUnitTestCoverage
    executionData.setFrom(buildDir.file("outputs/unit_test_code_coverage/debugUnitTest/testDebugUnitTest.exec"))
}
